...
class User(AbstractUser):
    ...
    nickname = models.CharField(null=True, max_length=15, unique=True)
    kakao_id = models.CharField(null=True,max_length=20, unique=False)
    address = models.CharField(null=True,max_length=40, unique=False)
